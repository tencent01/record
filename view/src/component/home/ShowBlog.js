...
class ShowBlog extends Component {
    ...
    onHandleClick(){
        this.props.onShowRecordView(false);
    }
            ...
            <div style={{width:'1px',height:'0px'} } className="float-left">
                ...
                >
                    <div className="shadow p-3 mb-5 bg-white rounded" style={{ width: 1035, height: window.innerHeight-50, backgroundColor: 'white',left:'50%'}}>
                        ...
                        <div style={{float:'left',height:window.innerHeight-120,overflow:'auto'}} className="" dangerouslySetInnerHTML={{__html:this.props.onShowRecordData}}>
