...
//        http.cors();
        http.authorizeRequests()
                .antMatchers("/user/login","/file/get","/blog/new","/blog/upload/img","/file/all","/file/read","/user/update/password","/user/login/test","/user/login/page","/user/login/error","/error/401","/static/**").permitAll()
